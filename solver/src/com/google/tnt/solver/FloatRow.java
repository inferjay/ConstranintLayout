...
class FloatRow implements IRow {
    ...
    public IRow createRowCentering(SolverVariable variableA, SolverVariable variableB, int marginA,
            float bias, SolverVariable variableC, SolverVariable variableD, int marginB, boolean withError,
            int errorStrength) {
        int indexSvA = variableA.mId;
        int indexSvB = variableB.mId;
    ...
    public void updateClientEquations() {
        ...
        for (int i = 1; i < count; i++) {
            ...
            SolverVariable variable = mLinearSystem.mIndexedVariables[i];
    ...
    public boolean updateRowWithEquation(IRow row) {
        ...
        SolverVariable v = source.variable;
        int indexSv = v.mId;
    ...
    public void pickRowVariable() {
        ...
        for (int i = 1; i < mLinearSystem.mNumColumns; i++) {
            ...
            SolverVariable candidateVariable = mLinearSystem.mIndexedVariables[i];
