 ...
 */
public class WidgetContainer extends android.constraint.solver.widgets.ConstraintWidget {
    protected ArrayList<android.constraint.solver.widgets.ConstraintWidget> mChildren = new ArrayList<>();
     ...
     * @param widget to add
     */
    public void add(android.constraint.solver.widgets.ConstraintWidget widget) {
     ...
     */
    public void remove(android.constraint.solver.widgets.ConstraintWidget widget) {
     ...
     */
    public ArrayList<android.constraint.solver.widgets.ConstraintWidget> getChildren() {
        return mChildren;
    }
    ...
    public ConstraintWidgetContainer getRootConstraintContainer() {
        android.constraint.solver.widgets.ConstraintWidget item = this;
        android.constraint.solver.widgets.ConstraintWidget parent = item.getParent();
     ...
     */
    public android.constraint.solver.widgets.ConstraintWidget findWidget(float x, float y) {
        android.constraint.solver.widgets.ConstraintWidget found = null;
        int l = getDrawX();
        int t = getDrawY();
        int r = l + getWidth();
        int b = t + getHeight();
        ...
        for (int i = 0, mChildrenSize = mChildren.size(); i < mChildrenSize; i++) {
            ...
            if (widget instanceof WidgetContainer) {
                android.constraint.solver.widgets.ConstraintWidget f = ((WidgetContainer) widget).findWidget(x, y);
                if (f != null) {
                    found = f;
                }
            } else {
     ...
     */
    public ArrayList<android.constraint.solver.widgets.ConstraintWidget> findWidgets(int x, int y, int width, int height) {
        ArrayList<android.constraint.solver.widgets.ConstraintWidget> found = new ArrayList<android.constraint.solver.widgets.ConstraintWidget>();
     ...
     * @return
     */
    public static Rectangle getBounds(ArrayList<android.constraint.solver.widgets.ConstraintWidget> widgets) {
        ...
        for (int i = 0, widgetsSize = widgets.size(); i < widgetsSize; i++) {
            final android.constraint.solver.widgets.ConstraintWidget widget = widgets.get(i);
            if (widget.getX() < minX) {
                minX = widget.getX();
            }
            if (widget.getY() < minY) {
