...
import android.constraint.solver.EquationCreation;
 ...
 * represents a constraint relation between the two anchors; the {@link android.constraint.solver.LinearSystem} will then
...
public class ConstraintWidget implements Solvable {
     ...
     */
    @Override
    public void setDebugSolverName(android.constraint.solver.LinearSystem system, String name) {
        mDebugName = name;
        android.constraint.solver.SolverVariable left = system.createObjectVariable(mLeft);
        android.constraint.solver.SolverVariable top = system.createObjectVariable(mTop);
        android.constraint.solver.SolverVariable right = system.createObjectVariable(mRight);
        android.constraint.solver.SolverVariable bottom = system.createObjectVariable(mBottom);
        left.setName(name + ".left");
        top.setName(name + ".top");
        right.setName(name + ".right");
        bottom.setName(name + ".bottom");
        if (mBaselineDistance > 0) {
            android.constraint.solver.SolverVariable baseline = system.createObjectVariable(mBaseline);
  ...
  public void forceUpdateDrawPosition() {
     ...
     */
    @Override
    public void addToSolver(android.constraint.solver.LinearSystem system) {
        if (getParent() != null) {
     ...
     */
    private void applyConstraints(android.constraint.solver.LinearSystem system, boolean wrapContent, boolean dimensionLocked,
        ...
        android.constraint.solver.SolverVariable begin = system.createObjectVariable(beginAnchor);
        android.constraint.solver.SolverVariable end = system.createObjectVariable(endAnchor);
        android.constraint.solver.SolverVariable beginTarget = system.createObjectVariable(beginAnchor.getTarget());
        android.constraint.solver.SolverVariable endTarget = system.createObjectVariable(endAnchor.getTarget());
     ...
     */
    @Override
    public void updateFromSolver(android.constraint.solver.LinearSystem system) {
