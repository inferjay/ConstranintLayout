...
import android.constraint.solver.SolverVariable;
...
public class Guideline extends ConstraintWidget {
    ...
    private android.constraint.solver.widgets.ConstraintAnchor mAnchor = mTop;
    ...
    public android.constraint.solver.widgets.ConstraintAnchor getAnchor() {
        return mAnchor;
    }
    ...
    @Override
    public android.constraint.solver.widgets.ConstraintAnchor getAnchor(android.constraint.solver.widgets.ConstraintAnchor.Type anchorType) {
        switch (anchorType) {
            case LEFT:
            case RIGHT: {
                if (mOrientation == VERTICAL) {
    ...
    @Override
    public ArrayList<android.constraint.solver.widgets.ConstraintAnchor> getAnchors() {
        return mAnchors;
    }
    ...
    public void addToSolver(android.constraint.solver.LinearSystem system) {
        android.constraint.solver.widgets.ConstraintWidgetContainer parent = (android.constraint.solver.widgets.ConstraintWidgetContainer) getParent();
        if (parent == null) {
            return;
        }
        android.constraint.solver.widgets.ConstraintAnchor begin = parent.getAnchor(android.constraint.solver.widgets.ConstraintAnchor.Type.LEFT);
        android.constraint.solver.widgets.ConstraintAnchor end = parent.getAnchor(android.constraint.solver.widgets.ConstraintAnchor.Type.RIGHT);
        if (mOrientation == HORIZONTAL) {
            begin = parent.getAnchor(android.constraint.solver.widgets.ConstraintAnchor.Type.TOP);
            end = parent.getAnchor(android.constraint.solver.widgets.ConstraintAnchor.Type.BOTTOM);
        }
        if (mRelativeBegin != -1) {
