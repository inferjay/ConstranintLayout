...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    protected android.constraint.solver.LinearSystem mSystem = new android.constraint.solver.LinearSystem();
    ...
    public static ConstraintWidgetContainer createContainer(ConstraintWidgetContainer
            container, String name, ArrayList<android.constraint.solver.widgets.ConstraintWidget> widgets, int padding) {
        ...
        android.constraint.solver.widgets.ConstraintWidget parent = widgets.get(0).getParent();
    ...
    public void addToSolver(android.constraint.solver.LinearSystem system) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (widget instanceof ConstraintWidgetContainer) {
                android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour horizontalBehaviour = widget.getHorizontalDimensionBehaviour();
                android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour verticalBehaviour = widget.getVerticalDimensionBehaviour();
                if (horizontalBehaviour == android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                    widget.setHorizontalDimensionBehaviour(android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour.FIXED);
                }
                if (verticalBehaviour == android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                    widget.setVerticalDimensionBehaviour(android.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour.FIXED);
                }
