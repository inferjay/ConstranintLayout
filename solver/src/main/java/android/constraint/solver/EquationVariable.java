...
class EquationVariable {
    ...
    private android.constraint.solver.Amount mAmount = null;
     ...
     */
    public EquationVariable(LinearSystem system, android.constraint.solver.Amount amount, String name, SolverVariable.Type type) {
        mAmount = amount;
     ...
     * @param amount the amount associated with this variable
     */
    public EquationVariable(android.constraint.solver.Amount amount) {
        mAmount = amount;
    }
    ...
    public EquationVariable(LinearSystem system, int amount, String name, SolverVariable.Type type) {
        mAmount = new android.constraint.solver.Amount(amount);
        mVariable = system.getVariable(name, type);
    }
    ...
    public EquationVariable(LinearSystem system, String name, SolverVariable.Type type) {
        mAmount = new android.constraint.solver.Amount(1);
        mVariable = system.getVariable(name, type);
    }
     ...
     */
    public EquationVariable(android.constraint.solver.Amount amount, EquationVariable variable) {
        mAmount = new android.constraint.solver.Amount(amount);
    ...
    public EquationVariable(EquationVariable v) {
        mAmount = new android.constraint.solver.Amount(v.mAmount);
     ...
     * @return amount
     */
    public android.constraint.solver.Amount getAmount() {
        return mAmount;
    }
     ...
     * @param amount the amount associated with this variable
     */
    public void setAmount(android.constraint.solver.Amount amount) {
        mAmount = amount;
    }
     ...
     */
    public void multiply(android.constraint.solver.Amount amount) {
