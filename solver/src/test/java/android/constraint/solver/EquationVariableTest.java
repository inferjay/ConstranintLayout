...
public class EquationVariableTest {
    LinearSystem s;
    android.constraint.solver.EquationVariable e1;
    android.constraint.solver.EquationVariable e2;

    @BeforeMethod
    public void setUp() {
        s = new LinearSystem();
        e1 = new android.constraint.solver.EquationVariable(s, 200);
        e2 = new android.constraint.solver.EquationVariable(s, 200);
    }
    ...
    public void testCompatible() {
        ...
        e2 = new android.constraint.solver.EquationVariable(s, 200, "TEST", SolverVariable.Type.UNRESTRICTED);
