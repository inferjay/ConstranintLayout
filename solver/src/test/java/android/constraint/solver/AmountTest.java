...
public class AmountTest {
    android.constraint.solver.Amount a1 = new android.constraint.solver.Amount(2, 3);
    android.constraint.solver.Amount a2 = new android.constraint.solver.Amount(3, 5);
